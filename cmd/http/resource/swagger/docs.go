...
const docTemplate = `{
  ...
  "info": {
    ...
    "description": "REST API for the ffxiv-census service: census summaries, character listings and details, aggregate statistics.",
    "version": "1.0"
  },
  "paths": {
    "/health": {
    ...
    "/health/ready": {
      "get": {
        ...
        "description": "Performs deep health check on database subsystem",
        "produces": [
          "application/json"
        ],
        "responses": {
